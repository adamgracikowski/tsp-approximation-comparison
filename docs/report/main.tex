...
\begin{enumerate}
    \item \textbf{Szybkość kosztem jakości:} Punkty reprezentujące algorytm 2-aproksymacyjny są wyraźnie przesunięte do lewej krawędzi wykresu (bardzo niskie czasy wykonania, od ułamków do kilkunastu milisekund), wykazując jednocześnie duży rozrzut wzdłuż osi rzędnych (błędy w przedziale 20--55\%). Jest to algorytm dedykowany dla systemów, w których szybkość podjęcia decyzji jest priorytetem, a mniejsza gorsza jakość wyznaczonej trasy jest kosztem w pełni akceptowalnym.
